...
# --------------------------
show_usage() {
    echo "Usage: ./build.sh [nn] [debug] [verify] [use_gpu] [force_gpu] [install_all] [no_onnx_test] [clion]"
    echo ""
    echo "Options:"
...
PYEOF
    ...
    echo "  Arguments:         <set EPDDL domain/problem/library arguments in CLion>"
