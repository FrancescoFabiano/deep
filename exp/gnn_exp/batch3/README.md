...
```console
python3 scripts/gnn_exp/bulk_coverage_run.py cmake-build-release-nn/bin/deep exp/gnn_exp/batch3/ --threads 8 --binary_args "-s Astar -u GNN --dataset_merged -c -b" --timeout 600
```
...
- the path to the experiment folder (`exp/gnn_exp/batch3/` which is this folder)
