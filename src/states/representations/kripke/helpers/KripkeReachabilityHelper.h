...
private:
     ...
     */
    [[nodiscard]] static KripkeWorldPointersSet get_B_reachable_worlds(const Agent& ag, const KripkeWorldPointer& world,
     ...
     */
    [[nodiscard]] static bool get_B_reachable_worlds_recursive(const Agent& ag, const KripkeWorldPointer& world,
     ...
     * \return Set of reachable worlds.
     */
    [[nodiscard]] static KripkeWorldPointersSet get_E_reachable_worlds(const AgentsSet& ags,
     ...
     * \return True if fixed point reached, false otherwise.
     */
    [[nodiscard]] static bool get_E_reachable_worlds_recursive(const AgentsSet& ags,
     ...
     */
    [[nodiscard]] static KripkeWorldPointersSet get_C_reachable_worlds(const AgentsSet& ags,
                                                                       const KripkeWorldPointer& world,
                                                                       const KripkeState& kstate);
