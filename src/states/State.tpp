...
State<StateRepr>::State(const State& prev_state, const Action& executed_action)
{
...
template <StateRepresentation StateRepr>
State<StateRepr> State<StateRepr>::compute_successor(const Action& executed_action)
{
...
template <StateRepresentation StateRepr>
void State<StateRepr>::print() const
{
...
template <StateRepresentation StateRepr>
void State<StateRepr>::print_dataset_format(std::ofstream& ofs, const bool use_hash, const bool is_merged) const
{
    m_representation.print_dataset_format(ofs, use_hash, is_merged);
}
