...
ArgumentParser::ArgumentParser() : app("deep") {
  ...
  search_group
      ->add_option(
          ...
          "'lib/epistemic_rl/models/default/distance_estimator.onnx'. Only used if "
          "HFS/Astar with GNN heuristics is selected.")
      ->default_val("lib/epistemic_rl/models/default/distance_estimator.onnx");
  search_group
      ...
      ->default_val("lib/epistemic_rl/models/default"
