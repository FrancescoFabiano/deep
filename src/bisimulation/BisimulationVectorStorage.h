 ...
 *
 * Each thread gets its own instance, ensuring the vectors are created and destroyed only once per thread.
 */
class BisimulationVectorStorage {
public:
    ...
    BisimulationVectorStorage& operator=(const BisimulationVectorStorage&) = delete;
