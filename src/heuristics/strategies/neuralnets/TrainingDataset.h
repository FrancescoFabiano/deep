...
public:
    ...
    ///< ID of the node that connects the two sub-graphs (goal and state) in the merged graph
...
private:
    ...
    double m_threshold_node_generation_log = std::log(m_threshold_node_generation * 3);
