...
struct GraphTensor {
    ...
    ///edge_src and edge_dest are used to create edge_index -> list <edge_source, edge_target> -> [2, num_edges]

    std::vector<int64_t> edge_attrs; ///< [1, num_edges] Edge attributes or labels,
