 ...
 *
 * This class extends BestFirstBase by filtering out states with negative heuristic values,
 * thereby ensuring that only promising states are added to the search queue.
 *
